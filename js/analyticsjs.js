//ga.js and analytics.js split for future use
var _gaq = _gaq || [];
var stFailbackDefaults = {
	trackScrolling: true,
	stLogInterval: 10, //interval , in seconds, between each time event
	docTitle: window.document.title,
	cutOffTime: 900, //cut off time in seconds
	trackNoEvents: false,
	trackNoMaxTime: false,
};
window.total_time = 0; //running time in seconds
